...
?>
<section class="b-block bg-dark b-viewport hero-section" style="background-image: url(<?php echo $banner_image['url']; ?>)">
    <div class="container align-items-center justify-content-center d-flex">
        <div class="row justify-content-center text-center hero-row">
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <?php if ($banner_button_link && $banner_button_label): ?>
                    <a href="<?php echo $banner_button_link ?>" class="btn mt-2 btn-primary"><span class="icon"><img src="<?php echo get_template_directory_uri();?>/images/play-icon.png" alt=""></span><?php echo $banner_button_label ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
